...
__all__ = ['get_default_parameters', 'get_path_experiments', 'get_path_alternative', 'get_path_data',
           'get_path_experiment', 'get_path_results', 'manager_factory', 'experiment_manager']
