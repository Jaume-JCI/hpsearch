...
__all__ = ['ExperimentManager', 'get_git_revision_hash', 'record_parameters', 'mypprint', 'mymakedirs',
           'find_closest_epoch', 'load_or_create_experiment_values', 'store_parameters', 'isnull',
           'get_experiment_number', 'get_experiment_numbers', 'set_logger', 'insert_experiment_script_path',
           'load_parameters', 'save_other_parameters']
