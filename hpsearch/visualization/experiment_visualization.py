...
def plot_metric_relationship (metric_1, metric_2, folder_experiments=None, run_numbers=None,
    ...
    df_metric_1 = ut.get_experiment_scores (experiment_data=df, score_name=f'{metric_1}', remove_score_name=True, run_number=run_numbers)
    df_metric_2 = ut.get_experiment_scores (experiment_data=df, score_name=f'{metric_2}', remove_score_name=True, run_number=run_numbers)
    ...
    if experiment_subset is not None:
        df_metric_1_subset = ut.get_experiment_scores (experiment_data=df.loc[experiment_subset], score_name=f'{metric_1}', remove_score_name=True, run_number=run_numbers)
        df_metric_2_subset = ut.get_experiment_scores (experiment_data=df.loc[experiment_subset], score_name=f'{metric_2}', remove_score_name=True, run_number=run_numbers)
