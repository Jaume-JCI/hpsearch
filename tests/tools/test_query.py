...
def test_do_query_and_show ():
    ...
    assert sorted(os.listdir (f'test_{path_results}/managers'))==['fields', 'info', 'logs.txt', 'whole']
    assert sorted(os.listdir (f'test_{path_results}/managers/whole'))==['DummyExperimentManager-default.pk', 'last.pk']
