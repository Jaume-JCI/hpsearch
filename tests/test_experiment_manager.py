...
__all__ = ['init_em_fixture', 'init_em', 'test_basic_usage', 'test_same_values', 'test_almost_same_values',
           ...
           'test_use_last_result', 'test_use_last_result_run_interrupted', 'test_grid_search',
